(function ($) {
    $(function () {
        ...
        function animateHeadline($headlines) {
            ...
            $headlines.each(function () {
                ...
                if (headline.hasClass('loading-bar')) {
                    ...
                    var spanWrapper = headline.find('.cd-words-wrapper'), newWidth = spanWrapper.width() + 10
        ...
        function getDifference(card, popup) {
            var cardDimensions = getDimensions(card), popupDimensions = getDimensions(popup);
            return {
        ...
        function scaleCard(e) {
            var el = closest(e);
            var target = el, id = target.getAttribute('data-popup-id'), popup = getPopup(id);
